        ...
        <div className={styles.card}>
            ...
            <div className={styles.cardInfo}>
                <h5>
                    ...
                    I'm a developer in making, born in Venezuela and 
                    currently living in Colombia, Medellin.
                    ****************************************
                    This project was made as an integration of the knowledge 
                    adquired during the course of M2,M3 and M2
                    of Soy Henry's bootcamp. 
                    </h5>

                    <Link to='https://github.com/Rosaskris'>
                    <button className={styles.card3} title='Visit my Github'>
                    ...
                    <button className={styles.card2} title='Connect with me'>
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="32" viewBox="0 0 32 32" className={styles.linkedin}>
